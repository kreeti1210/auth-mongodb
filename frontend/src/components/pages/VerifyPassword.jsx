    ...
    <div className="min-h-screen flex items-center justify-center  p-4">
      <div className="outine-1 outline-gray-300 shadow-lg flex flex-col md:flex-col p-8 md:w-1/3 max-w-6xl">
        ...
        <h3 className=" px-4 py-2 text-center text-gray-500  text-sm ">
          Verification token has been sent to{" "}
          <a href="mailto:{user.email}" className="font-semibold">
        ...
        <div className="px-4 py-2 flex flex-col ">
          ...
          <h4 className=" px-2 text-center  text-gray-500 text-sm mt-4 ">
            Not received email? Retry{" "}
            <a
              href="/register"
              className="text-green-700 hover:underline font-medium underline"
            >
              signing up
            </a>
          </h4>
